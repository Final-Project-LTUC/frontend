    ...
    <header>
      <div className={`test ${isNavFixed ? "fixed" : ""}`}>
        <div className="heroSection">
          ...
          <div class="heroText">
            <div className="heroTextLeft" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginLeft: '50px', fontSize: '1em' }}>
              <h1 style={{ fontSize: '3em', marginLeft: '55px'  }}>You can do it!</h1>
              <p style={{ width: '400px' }}> 
            ...
            <div className="heroTextCenter">
              <ChakraLink as={ReactRouterLink} to="/services">
                <button className="joinNow">Services</button>
              </ChakraLink>
              <ChakraLink as={ReactRouterLink} to="/about">
