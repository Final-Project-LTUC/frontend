...
export default function ImageUpload({
    ...
    return (
        <Flex
            ...
            position={`${
                currentPage === "profilePic" ? "relative" : "absolute"
            }`}
            transform={`translateX(${
                currentPage === "profilePic" ? "0" : "-200%"
            })`}
            h={`${currentPage === "profilePic" ? "calc(100vh - 80px)" : "0"}`}
            transition={"all .7s ease-in-out"}
        >
            <Text fontSize={"5vh"} color={"teal"}>
                                ...
                                >
                                    ...
                                    >
                                        <PreviewImage
                                            variants={first}
                                            backgroundImage={
                                                "url(https://images.unsplash.com/photo-1601058268499-e52658b8bb88?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80)"
                                            }
                                        />
                                        <PreviewImage
                                            variants={second}
