...
const TeamMemberCard = ({ name, position, imageSrc, linkedin, github, gmail }) => {
  return (
    <Box
      maxW={'270px'}
      w={'full'}
    ...
    >
      ...
      <Flex justifyContent={'center'}>
        <HStack spacing={3}>
          ...
          <SocialButton label={'Gmail'} href={`mailto:${gmail}`}>
            <FaEnvelope />
          </SocialButton>
        </HStack>
      </Flex>
...
const TeamMembers = () => {
  ...
  return (
    <Container as={Stack} maxW={'6xl'} py={10} ref={teamRef}>
      <Text fontWeight={'500'} fontSize={'3xl'} mb={5} fontFamily="cursive">Meet Our Team</Text>
      <SimpleGrid columns={{ base: 1, md: 3, lg: 5 }} spacing={4}>
        ...
        <TeamMemberCard
          name="Laith Saleem"
          position="Full Stack Developer"
          imageSrc="./assets/laith.png"
          linkedin="#"
          github="#"
          gmail="laith@gmail.com"
        />
        {/* Team Member 3 */}
        <TeamMemberCard
          name="Ala'a Nsairat"
          position="Full Stack Developer"
          imageSrc="./assets/alaa.png"
          linkedin="#"
          github="#"
          gmail="alaa@gmail.com"
        />
        {/* Team Member 4 */}
        <TeamMemberCard
          name="Mhamad Abdin"
          position="Full Stack Developer"
          imageSrc="./assets/mohamad.jpg"
          linkedin="#"
          github="#"
          gmail="mohamad@gmail.com"
        />
        {/* Team Member 5 */}
        <TeamMemberCard
          name="Bashar Al-irani"
          position="Full Stack Developer"
          imageSrc="./assets/bashar.jpg"
          linkedin="#"
          github="#"
          gmail="bashar@gmail.com"
        />
      </SimpleGrid>
    </Container>
  );
...
//   marginTop: '20px',
//   //boxShadow: '0 10px 50px rgba(164, 217, 20, 1)  ',
// };
...
//     <div  style={{ ...cardStyle, ...(isHovered ? cardHoverStyle : null) }}
...
//     <TeamMemberCard
//       name="Rama Almomani"
//       imageSrc='./assets/rama.jpg' // Use the imported image
...
//     <TeamMemberCard
//       name="Laith Saleem"
//       imageSrc='./assets/laith.png' // Use the imported image
//       description="Full Stack Developer"
//       linkedin="#"
//       github="#"
//     />
//     <TeamMemberCard
//       name="Ala'a Nsairat"
//       imageSrc='./assets/alaa.jpg' // Use the imported image
//       description="Full Stack Developer"
//       linkedin="#"
//       github="#"
//     />
//     <TeamMemberCard
//       name="Mohamad Abdin"
//       imageSrc='./assets/mohamad.jpg' // Use the imported image
//       description="Full Stack Developer"
//       linkedin="#"
//       github="#"
//     />
//     <TeamMemberCard
//       name="Bashar Alirani"
//       imageSrc='./assets/bashar.jpg' // Use the imported image
//       description="Full Stack Developer"
//       linkedin="#"
//       github="#"
//     />
...
//   fontSize: '2xl',
//   marginBottom: '1em',
//   marginRight: '1em', // Add right margin to separate from cards
// };
...
//   return (
//     <div
//       style={{ ...cardStyle, ...(isHovered ? cardHoverStyle : null) }}
//       onMouseEnter={handleMouseEnter}
//       onMouseLeave={handleMouseLeave}
//     >
//       <img src={imageSrc} alt="Person" className="card__image" style={cardImageStyle} />
...
//         />
//       </div>
//       <h1 style={titleStyle}>Meet Our Team</h1> {/* Add the title next to the cards */}
//     </div>
//   );
// }
