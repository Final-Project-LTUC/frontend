...
const UpdateLink=({setShowNum})=><Link colorScheme="teal" onClick={()=>setShowNum(1)} fontSize={'lg'} fontWeight={'semibold'} textAlign={'center'} display={'block'} to={'/dashUpdate'}>Update</Link>
function Profile({profileData,token,showPage,setShowNum}) {
  return (
    ...
    h={`'100vh'`}
    width={"100%"}
    boxShadow={'15px 5px 21px -10px rgba(0,128,128,0.43)'}
    >
        <Flex w={'100%'}>
      <CardHeader>
      </CardHeader>
